...
# for i in url_list:
#     spider=JDSpider(csv_filename=r"C:\\Users\\16075\\Desktop\\Code\\Python_code\\Data\\+".csv",url=url_list[i])
...
spider=JDSpider(csv_filename=r"C:\\Users\\16075\\Desktop\\Code\\Python_code\\Data\\iPhone 16 Pro Max"+".csv",url=url_list["iPhone 16 Pro Max"])
spider.crawl_comments(17,"好评")
time.sleep(10)
spider.crawl_comments(18,"中评")
time.sleep(10)
